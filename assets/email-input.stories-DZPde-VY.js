import{j as h}from"./jsx-runtime-D_zvdyIk.js";import{E as l}from"./preloader-B7BzVgwb.js";import{r as I}from"./iframe-C8_Lm2Ha.js";const{fn:E}=__STORYBOOK_MODULE_TEST__,S={title:"Components/EmailInput",component:l,args:{onChange:E()}},e={render:({value:n,placeholder:t,isIcon:o})=>{const[r,s]=I.useState(n),c=v=>{s(v.target.value)};return h.jsx(l,{onChange:c,value:r,name:"email",placeholder:t,isIcon:o})},args:{value:"bob@example.com",placeholder:"Логин",isIcon:!0}},a={render:({value:n,isIcon:t})=>{const[o,r]=I.useState(n),s=c=>{r(c.target.value)};return h.jsx(l,{onChange:s,value:o,name:"email",isIcon:t})},args:{value:"bob@example.com",isIcon:!1}};var u,m,p;e.parameters={...e.parameters,docs:{...(u=e.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: ({
    value,
    placeholder,
    isIcon
